...
<head>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/css/inscription.css">
</head>
<body>
    <header class="header">
        <div class="container">
            ...
            <div class="login-card register-card">
                ...
                <form class="login-form" action="<?= APP_URL ?>/register/submit" method="POST">
                    ...
                    <p class="terms-text">
                        ...
                        <a href="#" class="forgot-password">Conditions d'utilisation</a> et notre 
                        <a href="#" class="forgot-password">Politique de confidentialité</a>.
                    </p>
                </form>
    ...
    <script>
        ...
        student.addEventListener('change', function() {
            if(this.checked) {
                ...
                ecoleInput.setAttribute('required', 'required');
            }
        });
        ...
        owner.addEventListener('change', function() {
            if(this.checked) {
                ...
                ecoleInput.removeAttribute('required');
